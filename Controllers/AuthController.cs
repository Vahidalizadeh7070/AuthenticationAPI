...
namespace AuthenticationAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            User_MakeDecision userFunc= new User_MakeDecision(_userManager);
            var statusCode = await userFunc.MakeDecision(model.Email,model.Password);
        ...
        public async Task<IActionResult> Login([FromBody] LoginModel model)
        {
            ...
            return StatusCode(statusCode,new { Message= statusCode==200  ?  "You sign in is successfuly" : "Failed"});
        ...
        public async Task<IActionResult> Users()
        {
            ...
            return StatusCode(value.StatusCode, new { userName = value.Email });
        }
    }
}